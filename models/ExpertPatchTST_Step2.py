...
class Model(nn.Module):
    def __init__(self, configs, max_seq_len:Optional[int]=1024, d_k:Optional[int]=None, d_v:Optional[int]=None, norm:str='BatchNorm', attn_dropout:float=0., 
        ...
        num_attention_experts = configs.num_attention_experts
        num_ffn_experts = configs.num_ffn_experts
        num_active_experts = configs.num_active_experts        
        #print("Step2num_active_experts ",num_active_experts,flush=True,file=sys.stderr)
